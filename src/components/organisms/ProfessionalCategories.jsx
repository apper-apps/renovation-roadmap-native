...
<section id="professionals-section" className="py-16 bg-gray-50">
    <div className="container mx-auto px-4">
        <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-display font-bold text-primary mb-6">Depending on your project, you may need:
                          </h2>
        </div>
...
<div className="bg-accent/10 rounded-xl p-6 max-w-4xl mx-auto">
        ...
        <div className="mb-16">
            <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-display font-bold text-primary mb-4">Take Our Quiz to Find Out Who You Need
                                </h2>
                <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">Not sure where to start? Our interactive quizzes will help you understand your project needs and connect you with the right professionals.
                                </p>
            </div>
            {/* Featured Quiz */}
            <div className="mb-12">
