    ...
    <div className="py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl md:text-6xl font-display font-bold bg-gradient-to-r from-primary via-accent to-secondary bg-clip-text text-transparent mb-8">
            Your Renovation Roadmap
          </h1>
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Navigate your renovation journey with confidence. Our comprehensive step-by-step roadmap guides you 
      ...
      <div className="max-w-7xl mx-auto mb-20">
        ...
        <div className="relative">
          ...
          <div className="absolute left-10 top-20 h-full w-1 bg-gradient-to-b from-primary via-accent to-secondary rounded-full hidden lg:block shadow-lg"></div>
          <div className="space-y-12">
            {stages.map((stage, index) => (
              <div key={stage.Id} className="relative">
                {/* Enhanced Stage Number */}
                <div
                  className={`absolute left-0 w-20 h-20 rounded-full flex items-center justify-center text-white font-bold text-2xl cursor-pointer transition-all duration-300 shadow-xl ${
                    index === activeStage 
                      ? "bg-gradient-to-br from-accent via-warning to-accent scale-110 shadow-2xl animate-pulse" 
                      : "bg-gradient-to-br from-primary via-secondary to-primary hover:scale-105 hover:shadow-xl"
                  }`}
                ...
                <div className="ml-28 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden">
                  {/* Header with gradient background */}
                  <div className="bg-gradient-to-r from-gray-50 to-blue-50 px-8 py-6 border-b border-gray-100">
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between">
                      <h3 className="text-3xl font-display font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent mb-2 lg:mb-0">
                        {stage.title_c || stage.title}
                      </h3>
                      <div className="flex items-center text-gray-600 bg-white px-3 py-1 rounded-full shadow-sm">
                        ...
                        <span className="font-medium">{stage.duration_c || stage.duration}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-8">
                    <p className="text-gray-700 mb-8 text-lg leading-relaxed">
                      {stage.description_c || stage.description}
                    </p>
                    ...
                    {(() => {
                      // Parse professional IDs from database format
                      let professionalIds = [];
                      if (stage.professional_ids_c) {
                        professionalIds = stage.professional_ids_c.split(',').map(id => parseInt(id.trim()));
                      } else if (stage.professionalIds && Array.isArray(stage.professionalIds)) {
                        professionalIds = stage.professionalIds;
                      }

                      return professionalIds.length > 0 && (
                        <div>
                          <h4 className="text-xl font-semibold text-gray-900 mb-6 flex items-center">
                            <div className="w-1 h-6 bg-gradient-to-b from-accent to-secondary rounded-full mr-3"></div>
                            Professionals You Could Work With
                          </h4>
                                ...
                                >
                                  <div className="flex items-center">
                                    ...
                                    <span className="text-gray-800 group-hover:text-primary font-medium">
                                      A {(professional.type_c || professional.type || 'professional').toLowerCase()} like{' '}
                                  ...
                                  <img
                                    src={professional.logo_url_c || professional.logoUrl || "/api/placeholder/100/40"}
                                    alt={`${professional.Name || professional.name} logo`}
